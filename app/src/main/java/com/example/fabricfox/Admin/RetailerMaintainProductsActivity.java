...
public class RetailerMaintainProductsActivity extends AppCompatActivity {
    ...
    private void deleteThisProduct()
    {
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            {
                Intent intent = new Intent(RetailerMaintainProductsActivity.this, SellerCategoryActivity.class);
                startActivity(intent);
                finish();

                Toast.makeText(RetailerMaintainProductsActivity.this, "The Product Is deleted successfully.", Toast.LENGTH_SHORT).show();
            }
        });
    }
